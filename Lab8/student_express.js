...
//sorting the data by whose spi is more than 5
  app.get('/spiData',(req,res)=>{
    const spiData = data.filter(person=>person.spi>5)
    spiData.sort((a,b)=>b.spi-a.spi)  //sorting in descending order of spi
   res.send(spiData)
  })
  app.listen(8000,()=>{
